...
function About() {
    return (
        <div
            className="w-full h-[100vh] bg-[#0f0f0f] text-[#fefdf0] px-[4vw] py-[6vh]"
            // data-scroll
        ...
        >
            ...
            >
                <div>
                    ...
                    <button className="border-[#fefdf0] border-2 font-light rounded-full p-5 mt-10 text-xl hover:bg-[#fefdf0] hover:text-zinc-900 transition-all duration-300">
                        Take a Seat
                    </button>
                </div>
                <div className="flex gap-[5vw] text-xl ">
                    ...
                    <div>
                        {["X", "Instagram", "LinkedIn"].map((items, index) => {
                            return (
                                <div
                                    className="hover:underline underline-offset-2 decoration-2 flex items-center"
                                    key={index}
                                >
                                    {items}
                                    <HiMiniArrowSmallRight className="-rotate-45" />
                                </div>
                            );
                        })}
                    </div>
            ...
            <div className="flex justify-between text-xl mt-[35vh] font-light">
                <div>
                    <p>San Diego—California</p>
                    <p>Paris—France</p>
                </div>
                <div className="flex gap-[5vw] ">
                    <div>biz@rejouice.com</div>
                    <div>©2023 legal</div>
                </div>
            </div>
            <div className="relative [&_svg]:absolute [&_svg]:opacity-0">
                <motion.svg
                    initail={{ translateY: "-100%" }}
