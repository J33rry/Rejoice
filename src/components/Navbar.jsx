        ...
        <div>
            {isOpen ? (
                <div className="w-full h-[36vw] bg-red-700">
                    ...
                    <div className="flex justify-between items-center p-10 pt-2">
                        <div className="w-1/3">
                            <video
                                src={reel}
                                className="rounded-xl w-[25vw] h-[15vw] object-cover"
                                autoPlay
                                loop
                                // style={{ scale: 0.5 }}
                            ></video>
                            <div className="flex items-center">
                                <IoPlayCircle className="m-2 scale-150" />
                                <div className="flex items-center justify-between gap-x-[15vw] text-xl whitespace-nowrap pt-2">
                                    <p>Play reel</p>
                                    <p>-01:18</p>
                                </div>
                            </div>
